...
import {BrowserReact as Router,Route,Switch,Link,NavLink} from 'react-router-dom';
                   ...
                   {/*  <!------ SIDE MENU END ------>
                    ...
                    <div class="banner" data-parallax="scroll" data-image-src="assets/img/skult.png">
                        <ul class="breadcrumb">
                            ...
                            <li class="two"><a href="product-gallery.html">Contact</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 parent b">
                                ...
                                <form class="form-horizontal" action="/action_page.php">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="checkbox">
                                        <label><input type="checkbox" name="remember"/><img src="assets/img/captcha.png" class="img img-responsive"/><span>I'm not a robot</span></label>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group">        
